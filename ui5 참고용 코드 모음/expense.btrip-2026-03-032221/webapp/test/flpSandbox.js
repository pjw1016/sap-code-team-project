		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "신규 실비 등록",
									"targetURL": "#coded00expensebtrip-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"coded00expensebtrip-display": {
								"semanticObject": "coded00expensebtrip",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=code.d00.expense.btrip",
									"url": sap.ui.require.toUrl("code/d00/expense/btrip")
								}
							}
						}
					}
